...
public class AuthorizationPage {
    ...
    public void loginEmpty() {
        Allure.step("Выполнение входа с пустыми полями");
    ...
    public void checkWrongLoginAndPasswordError() {
        Allure.step("Проверка ошибки 'Неверный логин или пароль'");
    ...
    public void checkEmptyFieldsError() {
        Allure.step("Проверка ошибки 'Поля не заполнены'");
    ...
    public boolean isAuthPageDisplayed() {
        ...
        return ViewUtils.isViewDisplayed(ENTER_BUTTON_ID);
    }
}